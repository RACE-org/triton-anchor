    ...
    if(NOT DEFINED EXTERNAL_SPIRV_HEADERS_SOURCE_DIR)
      ...
      ${EXTERNAL_SPIRV_HEADERS_SOURCE_DIR}")
        ...
        FetchContent_Declare(spirv-headers
                # GIT_REPOSITORY    https://github.com/KhronosGroup/SPIRV-Headers.git  #fantgpu
                # GIT_REPOSITORY https://gitee.com/chenchang/SPIRV-Headers.git
                # GIT_REPOSITORY http://gitlab-sw.srv/ai-compiler/spirv-headers.git
                GIT_REPOSITORY git@gitee.com:bjtulyf/SPIRV-Headers.git
                GIT_TAG           ${SPIRV_HEADERS_TAG}
                SOURCE_DIR ${EXTERNAL_SPIRV_HEADERS_SOURCE_DIR}
                )
        message(STATUS "SPIR-V Headers is downloading")
        FetchContent_MakeAvailable(spirv-headers)
    endif()
    message(STATUS "SPIR-V Headers is ready")
    ...
    if(NOT DEFINED EXTERNAL_SPIRV_TOOLS_SOURCE_DIR)
      ...
      ${EXTERNAL_SPIRV_TOOLS_SOURCE_DIR}")
        ...
        FetchContent_Declare(spirv-tools
                # GIT_REPOSITORY    https://github.com/KhronosGroup/SPIRV-Tools.git #fantgpu
                # GIT_REPOSITORY https://gitee.com/chenchang/SPIRV-Tools.git
                # GIT_REPOSITORY http://gitlab-sw.srv/ai-compiler/spirv-tools.git
                GIT_REPOSITORY git@gitee.com:bjtulyf/SPIRV-Tools.git
                GIT_TAG           ${SPIRV_TOOLS_TAG}
                SOURCE_DIR ${EXTERNAL_SPIRV_TOOLS_SOURCE_DIR}
                )
        message(STATUS "SPIR-V Tools is downloading")
        FetchContent_MakeAvailable(spirv-tools)
    endif()
    message(STATUS "SPIR-V Tools is ready")
